...
void test160::Demo(void)
{
  Blah();
}

void test160::Cfunc(int32_t X)
{
  while (1) {
    _OUTA = X++;
  }
...
void test160::Blah(void)
{
  R = 1 + Coginit__(30, (void *)Stack, 128, (void *)Cfunc, 1, 0, 0, 0);
}

int32_t test160::Getfunc(int32_t X)
{
  return (_INA | X);
}
