...
instr_p2[] = {
    ...
    { "getnib", 0x08400000, THREE_OPERANDS_NIBBLE, OPC_GENERIC_NOFLAGS, 0 },
...
//  { "jnp",    0x0bb00000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH },
    ...
    { "qlog",   0x0d60000e, P2_DST_CONST_OK, OPC_GENERIC_NOFLAGS, 0 },
    { "qexp",   0x0d60000f, P2_DST_CONST_OK, OPC_GENERIC_NOFLAGS, 0 },
