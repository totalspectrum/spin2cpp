...
%left SP_NEGATE SP_FNEGATE SP_BIT_NOT SP_ABS SP_FABS SP_SQRT SP_FSQRT SP_DECODE SP_ENCODE SP_ENCODE2 SP_ALLOCA SP_ONES SP_BMASK SP_QLOG SP_QEXP SP_EXP2 SP_LOG2 SP_EXP10 SP_LOG10 SP_EXP SP_LOG /* priority 2 in Spin2 */
...
lhsseqcont:
  lhssingle
    {
        AST *item = NewAST(AST_EXPRLIST, $1, NULL);
        $$ = item;
    }
