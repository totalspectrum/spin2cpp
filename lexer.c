...
instr_p2[] = {
    ...
    { "encod",  0x07800000, TWO_OPERANDS_OPTIONAL, OPC_GENERIC, FLAG_P2_STD },
    { "ones",   0x07a00000, TWO_OPERANDS_OPTIONAL, OPC_GENERIC, FLAG_P2_STD },

    { "test",   0x07c00000, TWO_OPERANDS_OPTIONAL, OPC_TEST, FLAG_P2_STD },
    ...
    { "altd",   0x09880000, TWO_OPERANDS_DEFZ, OPC_GENERIC, 0 },
    { "alts",   0x09900000, TWO_OPERANDS_DEFZ, OPC_GENERIC, 0 },
