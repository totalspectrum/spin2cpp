...
instr_p1[] = {
    ...
    { "cmp",    0x84000000, TWO_OPERANDS, OPC_CMP, FLAG_P1_STD },
    { "cmps",   0xc0000000, TWO_OPERANDS, OPC_CMPS, FLAG_P1_STD },
    ...
    { "jmpret", 0x5c800000, JMPRET_OPERANDS, OPC_GENERIC_BRANCH, FLAG_P1_STD },
    ...
    { "test",   0x60000000, TWO_OPERANDS, OPC_TEST, FLAG_P1_STD },
    { "testn",  0x64000000, TWO_OPERANDS, OPC_TESTN, FLAG_P1_STD },
...
instr_p2[] = {
    ...
    { "cmp",    0x02000000, TWO_OPERANDS, OPC_CMP, FLAG_P2_STD },
    { "cmpx",   0x02200000, TWO_OPERANDS, OPC_GENERIC, FLAG_P2_STD },
    { "cmps",   0x02400000, TWO_OPERANDS, OPC_CMPS, FLAG_P2_STD },
    { "cmpsx",  0x02600000, TWO_OPERANDS, OPC_GENERIC, FLAG_P2_STD },
    { "cmpr",   0x02800000, TWO_OPERANDS, OPC_GENERIC, FLAG_P2_STD },
    ...
    { "andn",   0x05000000, TWO_OPERANDS, OPC_ANDN, FLAG_P2_STD },
    { "and",    0x05200000, TWO_OPERANDS, OPC_AND, FLAG_P2_STD },
...
//    { "res",  0x07e00000, TWO_OPERANDS, OPC_GENERIC_NR, FLAG_P2_STD },
    ...
    { "ijz",    0x0b400000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "ijnz",   0x0b480000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "ijs",    0x0b500000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "ijns",   0x0b580000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
  
    { "djz",    0x0b600000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "djnz",   0x0b680000, P2_TJZ_OPERANDS, OPC_DJNZ, 0 },
    { "djs",    0x0b700000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "djns",   0x0b780000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "tjz",    0x0b800000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "tjnz",   0x0b880000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "tjs",    0x0b900000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "tjns",   0x0b980000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },

//  { "jp",     0x0ba00000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH },
//  { "jnp",    0x0bb00000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH },
    
    { "callpa", 0x0bc00000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "callpb", 0x0bd00000, P2_TJZ_OPERANDS, OPC_GENERIC_BRANCH, 0 },

    { "jint",   0x0be80000, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jct1",   0x0be80200, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jct2",   0x0be80400, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jct3",   0x0be80600, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jse1",   0x0be80800, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jse2",   0x0be80a00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jse3",   0x0be80c00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jse4",   0x0be80e00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jpat",   0x0be81000, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jfbw",   0x0be81200, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jxmt",   0x0be81400, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jxfi",   0x0be81600, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jxro",   0x0be81800, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jxrl",   0x0be81a00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jatn",   0x0be81c00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jqmt",   0x0be81e00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },

    { "jnint",  0x0be82000, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnct1",  0x0be82200, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnct2",  0x0be82400, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnct3",  0x0be82600, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnse1",  0x0be82800, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnse2",  0x0be82a00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnse3",  0x0be82c00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnse4",  0x0be82e00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnpat",  0x0be83000, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnfbw",  0x0be83200, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnxmt",  0x0be83400, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnxfi",  0x0be83600, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnxro",  0x0be83800, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnxrl",  0x0be83a00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnatn",  0x0be83c00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
    { "jnqmt",  0x0be83e00, P2_JINT_OPERANDS, OPC_GENERIC_BRANCH, 0 },
